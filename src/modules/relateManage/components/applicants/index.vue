  ...
  export default {
    ...
    methods: {
      ...
      handleputRelateAddApplicant(id) {
        ...
        t.$store.dispatch("relateManageStore/putRelateAddApplicant", {caseId: t.currentCaseId, id: id})
          .then(res => {
            console.info(res)
          });
      },
      handleDeleteRelateDelApplicant(id) {
        const t = this;
        console.info(t.currentCaseId, id)
        t.$store.dispatch("relateManageStore/DeleteRelateDelApplicant", {caseId: t.currentCaseId, id: id})
          .then(res => {
            console.info(res)
          });
      }
